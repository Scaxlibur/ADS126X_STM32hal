...
/* Register Addresses */
	#define ID									(0x00)			/* 设备识别寄存器 ID/CFG REGISTER (ADDRESS 00h) */
	#define POWER1 								(0x01)			/* 电源寄存器 CONFIGURATION REGISTER 0 (ADDRESS 01h) */
	#define INTERFACE							(0x02)			/* 接口寄存器 CONFIGURATION REGISTER 1 (ADDRESS 02h) */
	#define MODE0								(0x03)			/* 模式0寄存器 High-Pass Filter Corner Frequency, Low Byte (Address 03h) */
	#define MODE1								(0x04)			/* 模式1寄存器 High-Pass Filter Corner Frequency, High Byte (Address 04h) */
	#define MODE2								(0x05)			/* 模式2寄存器 Offset Calibration, Low Byte (Address 05h) */
	#define INPMUX								(0x06)			/* 输入多路复用器寄存器 Offset Calibration, Mid Byte (Address 06h) */
	#define OFCAL0								(0x07)			/* 偏移校准寄存器0 Offset Calibration, High Byte (Address 07h) */
	#define OFCAL1								(0x08)			/* 偏移校准寄存器1 Full-Scale Calibration, Low Byte (Address 08h) */
	#define OFCAL2								(0x09)			/* 偏移校准寄存器2 Full-Scale Calibration, Mid Byte (Address 09h) */
	#define FSCAL0								(0x0A)			/* 全量程校准寄存器0 Full-Scale Calibration, High Byte (Address 0Ah) */
	#define FSCAL1								(0x0B)			/* 全量程校准寄存器1 */
	#define FSCAL2								(0x0C)			/* 全量程校准寄存器2 */
	#define IDACMUX								(0x0D)			/* IDACMUX寄存器 */
	#define IDACMAG								(0x0E)			/* IDACMAG寄存器 */
	#define REFMUX								(0x0F)			/* REFMUX寄存器 */
	#define TDACP								(0x10)			/* TDACP控制寄存器 */
	#define TDACN								(0x11)			/* TDACN 控制寄存器 */
	#define GPIOCON								(0x12)			/* GPIO连接寄存器 */
	#define GPIODIR								(0x13)			/* GPIO方向寄存器 */
	#define GPIODAT								(0x14)			/* GPIO数据寄存器 */
	/* Additional ADS1263 Registers */
	#ifdef ADS1263
		#define ADC2CFG							(0x15)			/* ADC2配置寄存器 */
		#define ADC2MUX							(0x16)			/* ADC2输入多路复用器寄存器 */
		#define ADC2OFC0						(0x17)			/* ADC2偏移校准寄存器0 */
		#define ADC2OFC1						(0x18)			/* ADC2偏移校准寄存器1 */
		#define ADC2FSC0						(0x19)			/* ADC2满量程校准寄存器0 */
		#define ADC2FSC1						(0x1A)			/* ADC2满量程校准寄存器1 */
	#endif /* ADS1263 */
...
/* Register Field Definitions */
	...
	/* POWER Register Fields */
		#define RST 							(0x10)			/* Indicates ADC reset has occurred. Clear this bit to detect the next device reset. */
		#define VBIAS 							(0x02)			/* Enables the internal level shift voltage to the AINCOM pin. */
		#define INTREF 							(0x01)			/* Enables the 2.5 V internal voltage reference. Note the IDAC and temperature sensor require the internal voltage reference. */

	/* INTERFACE Register Fields */
		#define TIMEOUT 						(0x08)			/* Enables the serial interface automatic time-out mode */
		#define STATUS 							(0x04)			/* Enables the inclusion of the status byte during conversion data read-back */
//		#define CRC1 							(0x02)
//		#define CRC0 							(0x01)
		#define CRC_MASK						(0x03)			/* Enables the inclusion of the checksum byte during conversion data read-back */
			//CRC Field
			#define CRC_OFF						(0x00)			/* Checksum byte disabled */
	...
	/* MODE0 Register Fields */
		...
		#define RUNMODE							(0x40)			/* Selects the ADC conversion (run) mode */
//		#define CHOP1 							(0x20)
//		#define CHOP0 							(0x10)
		#define CHOP_MASK						(0x30)			/* Enables the ADC chop and IDAC rotation options */
			//CHOP Field
...
//		#define FILTER_0 						(0x20)
		#define FILTER_MASK						(0xE0) 			/* Configures the ADC digital filter */
			//DELAY Field
		...
		#define SBADC 							(0x10)			/* Selects the ADC to connect the sensor bias */
		#define SBPOL 							(0x08)			/* Selects the sensor bias for pull-up or pull-down */
//		#define SBMAG2 							(0x04)
//		#define SBMAG1 							(0x02)
//		#define SBMAG0 							(0x01)
		#define SBMAG_MASK						(0x07)			/* Selects the sensor bias current magnitude or the bias resistor */
			//SBMAG Field
	...
	/* MODE2 Register Fields */
		#define BYPASS							(0x80)			/* Selects PGA bypass mode */
//		#define GAIN2 							(0x40)
//		#define GAIN1 							(0x20)
//		#define GAIN0 							(0x10)
		#define GAIN_MASK						(0x70)			/* Selects the PGA gain */
			//GAIN Field
			#define GAIN_1						(0x00)
			#define GAIN_2						(0x10)
			#define GAIN_4						(0x20)
...
//		#define DR1 							(0x02)
//		#define DR0 							(0x01)
		#define DR_MASK							(0x0F)			/* Selects the ADC data rate. In FIR filter mode, the available datarates are limited to 2.5, 5, 10 and 20 SPS */
			//DR Field
...
//		#define MUXP_1 							(0x20)
//		#define MUXP_0 							(0x10)
		#define MUXP_MASK						(0xF0)			/* Selects the positive input multiplexer */
			//MUXP Field
...
//		#define MUXN_1 							(0x02)
//		#define MUXN_0 							(0x01)
		#define MUXN_MASK						(0x0F)			/* Selects the negative input multiplexer */
			//MUXN Field
...
//		#define MUX2_1  						(0x20)
//		#define MUX2_0 							(0x10)
		#define MUX2_MASK						(0xF0)			/* Selects the analog input pin to connect IDAC2 */
			//MUX2 Field
...
//		#define MUX1_1 							(0x02)
//		#define MUX1_0 							(0x01)
		#define MUX1_MASK						(0x0F)			/* Selects the analog input pin to connect IDAC1 */
			//MUX1 Field
...
//		#define MAG2_1 							(0x20)
//		#define MAG2_0 							(0x10)
		#define MAG2_MASK						(0xF0)			/* Selects the current values of IDAC2 */
			//MAG2 Field
...
//		#define MAG1_1 							(0x02)
//		#define MAG1_0 							(0x01)
		#define MAG1_MASK						(0xF0)			/* IDAC1 Current Magnitude */
			//MAG1 Field
...
//		#define RMUXP_1	 						(0x10)
//		#define RMUXP_0	 						(0x08)
		#define RMUXP_MASK						(0x38)			/* Selects the positive reference input */
			//MUXP Field
...
//		#define RMUXN_0	 						(0x01)
	...
	/* TDACP Register Fields */
		#define OUTP	 						(0x80)			/* Connects TDACP output to pin AIN6 */
		//OUTP Field
...
//		#define MAGP1	 						(0x02)
//		#define MAGP0	 						(0x01)
		#define MAGP_MASK						(0x1F)			/* Select the TDACP output magnitude. The TDAC output voltages are ideal and are with respect to VAVSS */
			//MAGP Field
	...
	/* TDACN Register Fields */
		#define OUTN	 						(0x80)			/* Connects TDACN output to pin AIN7 */
		//OUTN Field
...
//		#define MAGN1	 						(0x02)
//		#define MAGN0	 						(0x01)
		#define MAGN_MASK						(0x1F)			/* Select the TDACN output magnitude. The TDAC output voltages are ideal and are with respect to VAVSS */
			//MAGN Field
	...
	/* GPIOCON Register Fields */								/* 默认不将GPIO和模拟输入连接 */
	...
	/* GPIODIR Register Fields */								/* 默认的GPIO方向是输入 */
		#define DIR7_AINCOM						(0x80)			/* Configures GPIO[7] as a GPIO input */
	...
	/* GPIODAT Register Fields */
		#define DAT7_AINCOM						(0x80)			/* Configured as an output, read returns 0b ; Configured as an input, write sets the register value only */
...
//					#define DR2_1	 			(0x80)
//					#define DR2_0	 			(0x40)
			#define DR2_MASK					(0xC0)			/* These bits select the data rate of ADC2 */
				//DR_2 Field
...
//					#define REF2_1				(0x10)
//					#define REF2_0	 			(0x08)
			#define REF2_MASK					(0x38)			/* Selects the reference inputs of ADC2 as positive and negative pairs */
				//REF2 Field
...
//					#define GAIN2_1				(0x02)
//					#define GAIN2_0				(0x01)
			#define GAIN2_MASK					(0x07)			/* These bits configure the gain of ADC2 */
				//GAIN2 Field
					#define GAIN2_1				(0x00)
					#define GAIN2_2				(0x01)
					#define GAIN2_4				(0x02)
...
//					#define MUXP2_1	 			(0x20)
//					#define MUXP2_0				(0x10)
				#define MUXP2_MASK				(0xF0)			/* Selects the ADC2 positive input */
				//MUXP2 Field
...
//					#define MUXN2_1				(0x02)
//					#define MUXN2_0				(0x01)
				#define MUXN2_MASK				(0x0F)			/* Selects the ADC2 negative input */
					//MUXN2 Field
					...
					#define MUXN2_TEMP			(0x0B)			/* Temperature sensor monitor positive */
					#define MUXN2_AVSS			(0x0C)			/* Analog power supply monitor positive */
					#define MUXN2_DVDD			(0x0D)			/* Digital power supply monitor positive */
					#define MUXN2_TEST			(0x0E)			/* TDAC test signal positive */
...
ADS126xData_t ADS126xReadData(uint8_t NumBytes, uint8_t DataByteStartNum);
